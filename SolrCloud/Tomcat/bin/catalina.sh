...
JAVA_OPTS="-Djetty.port=8080
-Dsolr.solr.home=/Library/Solr/example/solr
-Dbootstrap_confdir=/Library/Solr/example/solr/collection1/conf
-Dcollection.configName=collection1
-DzkHost=zplovett:2181,ubuntu:2181,wbuntu:2181
-DnumShards=3"
